...
import Recent 		from '../../components/sections/publications/recent'

import Color 	from '../../components/utils/page.colors.util'

import colors 		from '../../content/publications/_colors.json'
import settings 	from '../../content/_settings.json'

//
export default function Publications({ mediumArticles }) {
	return (
		<>
			<Color colors={colors} />
